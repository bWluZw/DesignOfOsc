...
class HyperGAN(kt.HyperModel):
    ...
    def build(self, hp):
        ...
        # TODO 这地方出问题，考虑将这个损失函数换到GAN网络实现中
    ...
    def fit(self, hp, model, x, **kwargs):
        ...
        # custom_score = CustomScore(self.gan_model.gen_loss_list,self.gan_model.disc_loss_list,gen_data[0],gen_data[1])
        # return 1-float(custom_score)
        # res = self.gan_model.gen_loss_tracker.result()
        return res.history['g_loss_score']
