...
def load_data(csv_file):
    ...
    return dataset,full_vocab, node_features_shape,edge_features_shape,max_atom_num,max_atom_type_num,max_bond_type_num,edge_len_num,max_smiles_len,max_smiles_char_type_num,vocab_size
...
class EncoderModel(keras.Model):
    def __init__(self, hp,config,node_features_shape,edge_features_shape,max_atom_num,max_atom_type_num,max_bond_type_num,edge_len_num):
        ...
        self.z_mean = layers.Dense(512, dtype="float32", kernel_regularizer=keras.regularizers.l2(0.01), name="z_mean")
        self.log_var = layers.Dense(512, dtype="float32", kernel_regularizer=keras.regularizers.l2(0.01), name="log_var")
